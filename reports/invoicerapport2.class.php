...
class invoiceRapport2 Extends reportBaseController{
    public function run() {
        ...
        fwrite($output,
                ...
                $this->encloseWithQuotes("gavepapir").";".
                $this->encloseWithQuotes("Levering virksomhed").";".
             "\n");



     $shops = '57,58,59,272';     //Norske shops
...
//                    $this->encloseWithQuotes($companyorder->quantity).";".        changed to active users
                    ...
                    $this->encloseWithQuotes($companyorder->giftwrap).";".
