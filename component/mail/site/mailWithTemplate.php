...
<div id="tabs">
  ...
  <div id="tabs-1">
    <?php include("mailWithTemplate.code.php") ?>
  </div>
</div>
<div id="ripperContainer" style="width: 700px; height: 1011px;" ></div>
  <div id="ripperContainer2" style="width: 810px; height: 1170px;"></div>
</body>
</html>