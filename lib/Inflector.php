...
abstract class Inflector
{
	...
	{
		return preg_replace(array('/[_\- ]+/','/([a-z])([A-Z])/'),array('_','\\1_\\2'),trimgf($s));
	}
...
class StandardInflector extends Inflector
{
	...
	public function variablize($s) { return str_replace(array('-',' '),array('_','_'),strtolower(trimgf($s))); }
}
?>