...
';
            ...
            $CompanyOrderRs = CompanyOrder::find_by_sql("SELECT contact_email,company_id,shop_id from company_order WHERE id = " . $companyOrderID);
    ...
    public function csMailAfterSaleWeb()
    {
        ...
        switch ($lang) {
            case 1:
                $this->mailAfterSaleWeb($id);
                break;
            case 4:
                $this->mailAfterSaleWebNorge($id);
                break;
            case 5:
                $this->mailAfterSaleWebSverige($id);
                break;
            default:
                echo "none";
                return;
