...
/*
  ...
  */
  ...
  public function freeShipmentSe(){
        ...
        $sqlGetOrderID = "select id from company_order where shop_id in (1832,1981,4793,5117,8271) and shipment_ready = 0 and is_printed = 0 and is_shipped = 0 limit 1";
