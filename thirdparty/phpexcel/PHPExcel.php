...
class PHPExcel
{
	...
	*/
	...
	{
		$worksheetCount = countgf($this->_workSheetCollection);
    ...
    public function removeSheetByIndex($pIndex = 0)
    {
        ...
        $numSheets = countgf($this->_workSheetCollection);
        ...
        if (($this->_activeSheetIndex >= $pIndex) &&
            ($pIndex > countgf($this->_workSheetCollection) - 1)) {
            --$this->_activeSheetIndex;
        }
    ...
    {
        return countgf($this->_workSheetCollection);
    }
    ...
    public function addExternalSheet(PHPExcel_Worksheet $pSheet, $iSheetIndex = null) {
        ...
        $countCellXfs = countgf($this->_cellXfCollection);
    ...
    {
        if ($pIndex > countgf($this->_cellXfCollection) - 1) {
    ...
    {
        if ($pIndex > countgf($this->_cellStyleXfCollection) - 1) {
