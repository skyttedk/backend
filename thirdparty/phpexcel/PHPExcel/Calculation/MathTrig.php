...
class PHPExcel_Calculation_MathTrig {
	...
	public static function GCD() {
		...
		$allValuesCount = countgf($allValuesFactors);
		if ($allValuesCount == 0) {
			return 0;
		}
		...
		$mergedArrayValues = countgf($mergedArray);
	...
	public static function SUMX2MY2($matrixData1,$matrixData2) {
		...
		$count1 = countgf($array1);
		$count2 = countgf($array2);
		if ($count1 < $count2) {
			$count = $count1;
		} else {
			$count = $count2;
