...
<body>
<img class="bi-flag bi-select-flag" data-id="dk" style="margin-left:20px; " id="bi-dk-lang" src="../gavefabrikken_backend/views/media/icon/denmark-flag-medium (1).png" height=30 />
<img class="bi-flag" data-id="no" src="../gavefabrikken_backend/views/media/icon/norway-flag-medium (1).png" height=30 />
<img class="bi-flag" data-id="se" src="../gavefabrikken_backend/views/media/icon/sw-flag.webp" height=30 />
<div>
 ...
 <div id="biTabs">
  ...
  <div id="tabs-1">
     <p>*import dækker over det salg kunderne selv har indtastet på vores salgssider.</p>
