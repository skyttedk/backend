  ...
  <script>
   function validateForm() {
    ...
    <body onload="">
     ...
     <h3>Bestil drommegavekort</h3>



    <form action="/gavefabrikken_backend/index.php?rt=bestilling/drommegavekortet" onsubmit="return validateForm()" method="post" accept-charset="UTF-8">


      <input type="hidden" name="shop_name" value="drommegavegavekortet"/>


            <b>Værdi</b><br>
      <br>
      <input type="radio" required name="shop_id" value="287">100<br>
      <input type="radio" name="shop_id" value="290">200<br>
      <input type="radio" name="shop_id" value="310">300<br>
      ...
      <input type="radio" checked="checked" required name="shipment_method" value="e">Elektronik<br>
