...
//               $("#presentFlipId_"+value).hide();
    ...
    _this.initPresentInShop = function() {
     ...
     // var cardShopList = [52,53,54,55,56,57,58,59,272,290,310,574,575,1832,1981,2395,2548,2549,2550,2558,2960,2961,2962,2963,4793,5117,4668];
      var cardShopList = [52,53,54,55,56,57,58,59,272,290,310,574,575,1832,1981,2395,2550,2960,2961,2962,2963,4662,4668,4740,4793,5117,7121,8355, 8356, 8357, 8358, 8359, 8360, 8361, 8362, 8363, 8364, 8365, 8366];
      ...
      $.each(presentList, function(key, value)
        {
          ...
          if(value.active == 1 ) {
            ...
            if(value.is_deleted == 0){
                ...
                html += "<div class=\"group\" id=\"vsg-item_"+value.present.attributes.id+"\" > <h3 class=\"vsg-accordion\"  data-id=\""+value.present.attributes.id+"\">"+presentHeadlineName+"<div id=\"catOverview"+value.present.attributes.id+"\"  >"+catName+"</div> </h3> <div><p><center>"
