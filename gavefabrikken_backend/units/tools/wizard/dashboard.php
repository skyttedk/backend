...
<div class="container mt-5">
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-6 col-lg-4">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title"></i> Slet gavevalg</h5>
                    <p class="card-text">Slet et gavevalg fra et gavekort.</p>
                    <a href="<?php echo $servicePath; ?>removecardorder" class="btn btn-primary">Gå til værktøj</a>
                </div>
            </div>
        ...
        <div class="col-12 col-md-6 col-lg-4" style="">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title"></i> Rapport værktøj</h5>
                    <p class="card-text">Rapporteringslisten</p>
                    <a href="index.php?rt=unit/lister/rapporter/dashboard" class="btn btn-primary">Gå til værktøj</a>
                </div>
            </div>
        ...
        <div class="col-12 col-md-6 col-lg-4">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title"></i> Afslutnings dashboard</h5>
                    <p class="card-text">Dashboard der viser status på afslutninger samt mulighed for afslutning.</p>
                    <a href="index.php?rt=unit/navision/afslutning/dashboard" class="btn btn-primary">Gå til værktøj</a>
                </div>
            </div>
