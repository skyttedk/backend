    ...
    static mainTemplate() {
        return `
            ...
            <form id="orderDataForm" style="max-width: 700px;">
                        ...
                        <!-- DOT Section -->
                        <div class="accordion-item">
                            <h4 class="accordion-header" id="heading-dot">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-dot" aria-expanded="false" aria-controls="collapse-dot">
                                    DOT
                                </button>
                            </h4>
                            <div id="collapse-dot" class="accordion-collapse collapse" aria-labelledby="heading-dot" data-bs-parent="#orderFormAccordion">
                                <div class="accordion-body">
                                    <div class="row">
                                        <div class="col-3">
                                            <br>
                        ...
                        <!-- Opbæring Section -->
                        <div class="accordion-item">
                            <h4 class="accordion-header" id="heading-opbaering">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-opbaering" aria-expanded="false" aria-controls="collapse-opbaering">
                                    Opbæring
                                </button>
                            </h4>
                            <div id="collapse-opbaering" class="accordion-collapse collapse" aria-labelledby="heading-opbaering" data-bs-parent="#orderFormAccordion">
                                <div class="accordion-body">
                                    <div class="row">
                                        <div class="col-3">
                                            <br>
                        ...
                        <!-- Udlån Section -->
                        <div class="accordion-item">
                            <h4 class="accordion-header" id="heading-udlaan">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-udlaan" aria-expanded="false" aria-controls="collapse-udlaan">
                                    Udlån (Dette bør undgås)
                                </button>
                            </h4>
                            <div id="collapse-udlaan" class="accordion-collapse collapse" aria-labelledby="heading-udlaan" data-bs-parent="#orderFormAccordion">
                                <div class="accordion-body">
                                    <div class="row">
                                        <div class="col-3">
                                            <div class="form-group">
                        ...
                        <!-- Vigtige deadlines Section -->
                        <div class="accordion-item">
                            <h4 class="accordion-header" id="heading-deadlines">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-deadlines" aria-expanded="false" aria-controls="collapse-deadlines">
                                    Vigtige deadlines
                                </button>
                            </h4>
                            <div id="collapse-deadlines" class="accordion-collapse collapse" aria-labelledby="heading-deadlines" data-bs-parent="#orderFormAccordion">
                                <div class="accordion-body">
                                    <div class="form-group">
                        ...
                        <!-- Specifikationer Section -->
                        <div class="accordion-item">
                            <h4 class="accordion-header" id="heading-specs">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-specs" aria-expanded="false" aria-controls="collapse-specs">
                                    Specifikationer
                                </button>
                            </h4>
                            <div id="collapse-specs" class="accordion-collapse collapse" aria-labelledby="heading-specs" data-bs-parent="#orderFormAccordion">
                                <div class="accordion-body">
                                    <div class="form-group">
                ...
                <!-- Accordion styling -->
                <style>
                /* Accordion styling for orderdata form */

                /* Header styling - ændret til en mere neutral farve */
                .orderdata-accordion .accordion-button {
                    background-color: #6c757d; /* Ændret fra #0d6efd til en mere neutral grå */
                    color: white;
                    font-weight: bold;
                    border: 1px solid #5a6268;
                }

                .orderdata-accordion .accordion-button:not(.collapsed) {
                    background-color: #5a6268; /* Mørkere grå når udvidet */
                    color: white;
                    border-bottom: none;
                }

                .orderdata-accordion .accordion-button:focus {
                    box-shadow: 0 0 0 0.25rem rgba(108, 117, 125, 0.5);
                }

                /* Ændrer farven på dropdown-pilen */
                .orderdata-accordion .accordion-button::after {
                    background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%23ffffff'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
                }

                .orderdata-accordion .accordion-button:not(.collapsed)::after {
                    background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%23ffffff'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
                }

                /* Indhold styling */
                .orderdata-accordion .accordion-body {
                    background-color: #f8f9fa; /* Lysere grå baggrund */
                ...
                /* Tilføjer mere mellemrum mellem accordion elementer */
                .orderdata-accordion .accordion-item {
                    margin-bottom: 10px;
                }

                /* Formular felt styling forbedringer */
                .orderdata-accordion .form-control:focus {
                    border-color: #86b7fe;
                    box-shadow: 0 0 0 0.25rem rgba(108, 117, 125, 0.25);
                }

                .orderdata-accordion .form-group {
                    margin-bottom: 1rem;
                }

                /* Gem og Godkend Ordre knapper styling */
                .save_button {
