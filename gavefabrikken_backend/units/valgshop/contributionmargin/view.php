...
// If simple mode, just return JSON directly
if ($simple) {
    // Call the calculation endpoint directly
    $_POST["shop_id"] = $shopID;
    $_POST["simple"] = true;

    $controller = new \GFUnit\valgshop\contributionmargin\Controller();
    $controller->calculateContributionMargin();
    exit;
}
?>
<!DOCTYPE html>
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <div class="d-flex align-items-center">
                            <input type="text" id="searchInput" class="form-control form-control-sm" placeholder="Søg varenr, navn eller present ID..." style="width: 250px;">
                            <button id="clearSearchBtn" class="btn btn-sm btn-outline-secondary ms-1">×</button>
                        </div>
