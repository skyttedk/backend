...
class Controller extends UnitController
{
    ...
    public function generateCSV()
    {
        ...
        $this->_genererOgDownloadCSV($data, 'data_export_', ['ID', 'NavnSys', 'Navn', 'SO-nummer', 'Debitornummer', 'Lagerlokation', 'Antal solgt']);
    }
    ...
    private function _getSoldPrShop($shopType, $country)
    {
        ...
        $sql = "SELECT shop_user.shop_id, shop.name, shop_metadata.so_no, 
                shop.reservation_code, COUNT(DISTINCT shop_user.id) AS user_count
                FROM `shop_user` 
                ...
                WHERE 
                  ...
                  shop_user.`blocked` = 0 
                GROUP BY shop_id, shop.name, shop_metadata.so_no, shop.reservation_code";
