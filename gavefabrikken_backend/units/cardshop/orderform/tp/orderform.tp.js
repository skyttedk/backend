    ...
    static DeadlineFormShops(data){
         ...
         return `<select class="madatory-select" id="OrderFormDeadlineSelect"><option disabled="disabled" selected="" value="0">V&oelig;lg</option>`+
            ...
            if(i.sale_is_open == true || i.websale_is_open == true){
               ...
               return `<option class='OrderFormDeadlineOption' value='${i.expire_date}'  allinclusive='${i.all_inclusive}' special= '${i.special}' saleisopen = '${i.sale_is_open}' homedelivery = '${i.week_no}' websaleisopen = '${i.websale_is_open}' useenvfee = '${i.use_envfee}'  > ${weekLabel} - ${i.display_date}</option>`
            }
        }).join('') + `</select>`;
    }
    ...
    static earlyOrderPresent(data,unique=""){
            ...
            return ` <div class="row earlyOrder ${unique}">
                    <div class="col-6 justify-content-center align-self-center">
                        ...
                        <select data-id="${unique}"  class="${unique}" style="max-width: 100%;"><option  selected="" value="none">V&oelig;lg</option>`+
            data.map((i) => {
                return `
