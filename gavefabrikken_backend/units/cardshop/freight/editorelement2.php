...
class EditorElement2
{
    ...
    public function renderEditor()
    {
        ...
        $att = $this->freightItem->getShipToAttention();
        if(trim($att) == "" || $att == "11111111") {
            $att = $this->freightItem->getContactName();
        }

        if($parent != null && (trim($att) == "" || $att == "11111111")) {
            $att = $parent->ship_to_attention;
        }
        ...
        */
        ...
        <td style="vertical-align: top; padding: 5px;">
            <?php if ($canUseDot) {
                ...
                if($cardshopFreight != null && $cardshopFreight->dot_date_end == null) {
                    $cardshopFreight->dot_date_end = $cardshopFreight->dot_date;
                }
                ...
                <div class="dotdetails" style="display: <?php if ($cardshopFreight != null && $cardshopFreight->dot == 1) echo "block"; else echo "none"; ?>; margin-top: 4px;">
                    ...
                    <div style="padding-top: 4px;">
                        DOT dato: <input type="date" name="dot_date" class="dot_date" value="<?php if ($cardshopFreight == null || $cardshopFreight->dot_date == null) echo ""; else echo $cardshopFreight->dot_date ? $cardshopFreight->dot_date->format('Y-m-d') : '' ?>" >
                    </div>
                    <div style="padding-top: 4px;">
                        Fra kl. <input type="time" name="dot_time_from" class="dot_time dot_time_from" value="<?php if ($cardshopFreight == null || $cardshopFreight->dot_date == null) echo ""; else echo $cardshopFreight->dot_date ? $cardshopFreight->dot_date->format('H:i') : '' ?>" >
                        til kl. <input type="time" name="dot_time_to" class="dot_time dot_time_to" value="<?php if ($cardshopFreight == null || $cardshopFreight->dot_date_end == null) echo ""; else echo $cardshopFreight->dot_date_end ? $cardshopFreight->dot_date_end->format('H:i') : '' ?>" >
                    </div>
                </div>
