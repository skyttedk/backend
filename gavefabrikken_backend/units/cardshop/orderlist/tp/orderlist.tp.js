export default class OrderlistTp {
    ...
    static ValuesFormShops(data,selectedValues){
        ...
        return data.map((value) => {
            ...
            return `<div><label >
            <input type="checkbox" class="cardvalues" ${checked} value="${value}">
            ${value}
        </label></div>`;
        }).join('');
    }
    ...
    static editOrder(data){
        ...
        return `
        <br><div id="OrderEditValuesContainer" style="display: none;">
            <label><b>Beløb:</b> (der kan vælges flere)</label>
            <div class="row ">
                <div class="col-12" id="OrderEditValues">
                </div>
            </div>
            <hr>
        </div><div>
            ...
            <hr>
            <div class="row ">
                <div class="col-6" id="freecardsdiv" style="display: none;">
            ...
            <div class="row ">
                <div class="col-12">
                    <div style="background: #FAFAFA; border: 1px solid #F0F0F0; margin-top: 10px; padding: 10px;">
                    <label><input type="checkbox" name="sendob" id="sendob" value="1"> Tving ny ordrebekræftelse til kunde</label><br>
                    Sæt kryds her for at være sikker på at der sendes en ny ordrebekræftelse.
                    </div>
                </div>
            </div>
