...
<div style="position: fixed; top: 0px; left: 0px; padding: 15px; background: #F5F5F5; width: 100%; height: 200px;">
    <div class="row sticky-top">
        ...
        <div class="col-12 mt-2 d-flex flex-wrap">
            ...
            <div class="p-1 flex-fill">
                Betaling:<br>
                <select class="form-control selectpicker mb-2" multiple data-live-search="true" id="payment-status">
                    <option value="10">Ingen a-conto</option>
                    <option value="20">A-conto ikke betalt</option>
                    <option value="30">A-conto betalt</option>
                </select>
            </div>
