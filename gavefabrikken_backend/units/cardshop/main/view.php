...
?>
    ...
    <div class="toast-body">
        ...
        <div class="cardshop-main">
            ...
            <button id="cardshop-settings-btn" type="button" class="btn btn-warning" style="display: none; font-size:12px !important; margin-top: 10px; margin-right: 10px;float: right;" title="Opsætning og status"><i class="bi bi-wrench"></i></button>
