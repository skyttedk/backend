...
export default class Main extends Base  {
    ...
    async InitCardshop(){
        ...
        const allowedUserIds = [50, 110, 86, 304, 305,332,331,190,175,338,291];
        if(allowedUserIds.includes(Number(window.USERID))) {
            $('#cardshop-settings-btn').show();
            $('#cardshop-settings-btn').unbind("click" ).click(function(){
                $('.cardshop-main-content').html('<iframe style="width: 100%; height: 100%;" src="index.php?rt=unit/cardshop/status/mainpage"></iframe>');
            });
