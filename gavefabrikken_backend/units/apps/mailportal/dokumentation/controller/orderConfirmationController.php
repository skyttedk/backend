...
class orderConfirmationController Extends baseController {
    ...
    public function runOrdersSE()
    {
        ...
        $sql = "SELECT *  FROM `company_order` WHERE `shop_id` IN (1832,1981) && is_cancelled = 0 && is_invoiced = 0 ORDER BY id ASC";
    ...
    private function sendReceiptMail($companyOrderid,$checkIsInvoiced = false)
    {
        ...
        */
        if($companyOrder->shop_id==1832 || $companyOrder->shop_id==1981) {
        ...
        // Company Information
        if($companyOrder->shop_id==57 || $companyOrder->shop_id==58 || $companyOrder->shop_id==59 || $companyOrder->shop_id==272 || $companyOrder->shop_id==1832 || $companyOrder->shop_id==1981) {
