...
//        $this->cardShops(1);
        ...
        $this->cardShops2(" 52,54,55,56,53,290,310,575,2548,2395", "dk");
        $this->cardShops2("57,58,59,272,574,2550,2549", "no");
        $this->cardShops2("1832,1981,2558", "se");
...
where 
    ...
    (shop_user.blocked = 1 || shop_user.shutdown = 1 || shipment.itemno != present_model.model_present_no)";
