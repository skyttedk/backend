...
*/
    ...
    public function syncShipment(\Shipment $s)
    {
        ...
        if($shipment->shipment_type == "earlyorder") {
            if($shipment->handler != $cardshopSettings->earlyorder_handler) {
