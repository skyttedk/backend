...
*/
        ...
        */
        ...
        else
        {
            ...
            if($priceSettings->card_price != $orderItems["CONCEPT"]->price) {
    ...
    private function checkCompanyState($companyOrder,$company)
    {
        ...
        $companyBlocks = \BlockMessage::find_by_sql("SELECT * FROM `blockmessage` WHERE `company_id` = ".$company->id." AND `release_status` = 0");
