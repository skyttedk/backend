...
export default class Approvelist extends Base {
    ...
    Layout(){
        $(".cardshop-main-content").html( tpApprovelist.localisation() + "<span style='margin-left:10px;'></span>" +tpApprovelist.filterList() + "<span style='margin-left:10px;'></span>" + tpApprovelist.showTech()+"<br><div id='overviewContainer'></div>" )
        $("#localisation-tp").val()
