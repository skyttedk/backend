...
*/
        ...
        if(orderstate != 2 ){
          bn = ` <button data-id=${shopuserID} class="btn btn-outline-primary updateMasterData" style="float:right; margin-right:10px"  >Opdatere data</button> `;
           ...
           bn = `<button data-id=${shopuserID} class="btn btn-outline-danger updateMasterData" style="float:right; margin-right:10px"  >Opdatere data (Gaven er sendt, &oelig;ndringerne vil kun blive gemt i CS og ikke komme over i NAV)</button>`;
        }
