...
//            var_dump($description_se);
        ...
        $budget_price_se =  $att->budget_price_se[0]->value ?? false ? $att->budget_price_se[0]->value : 0;
        // kost pris fra nav
        ...
        /**** UPDATE ****/
            ...
            //------- NavPriceOverRuleSync END --------------------
              ...
              WHERE `id` = ?");
                ...
                $stmt->bind_param("ssssssssssiiisiidiiiss", $erp_product_name_no, $erp_product_name_da, $logoKontainerID, $vendor, $ptimage, $ptimageSmall, $img2Show, $kun_hos_gavefabrikken_da, $sqlPt_price, $sqlPt_price_no, $gave_med_omtanke_da, $show_in_sales_module, $show_in_sales_module_no, $cost_price_da, $cost_price_no, $cost_price_da, $budget_price_da, $cost_price_no, $budget_price_no, $vejl_udsalgspris_tekst_da, $vejl_udsalgspris_tekst_no, $ID);
...
*/
            ...
            /*   Jeg fravælger at opdateret valgte gaver
            if($itemnr != ""){
