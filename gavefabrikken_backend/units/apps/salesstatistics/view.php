<div class="container-fluid">
        ...
        <div class="card-body">
            <div class="row align-items-end">
                <div class="col-md-2 mb-3">
                    ...
                    <select id="salespersonSelect" class="form-select">
                        <option value="import" selected>Import (standard)</option>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    <h6 class="m-0 font-weight-bold text-primary">Årssammenligning (2023-2025)</h6>
                    <div>
                        <div class="btn-group btn-group-sm me-3" role="group">
                            <input type="radio" class="btn-check" name="yearlyComparisonMode" id="yearlyComparisonRevenue" autocomplete="off" checked>
                            <label class="btn btn-outline-primary btn-sm" for="yearlyComparisonRevenue">Omsætning</label>
                            
                            <input type="radio" class="btn-check" name="yearlyComparisonMode" id="yearlyComparisonSales" autocomplete="off">
                            <label class="btn btn-outline-primary btn-sm" for="yearlyComparisonSales">Antal kort</label>
                        </div>
                        <div class="btn-group btn-group-sm me-3" role="group">
                            <input type="radio" class="btn-check" name="yearlyChartType" id="yearlyChartCumulative" autocomplete="off" checked>
                            <label class="btn btn-outline-success btn-sm" for="yearlyChartCumulative">Kumulativ</label>
                            
                            <input type="radio" class="btn-check" name="yearlyChartType" id="yearlyChartMonthly" autocomplete="off">
                            <label class="btn btn-outline-success btn-sm" for="yearlyChartMonthly">Månedsvis</label>
                        </div>
                        <select id="yearlyComparisonConceptFilter" class="form-select form-select-sm d-inline-block" style="width: auto;">
                            <option value="">Alle koncepter</option>
                        </select>
                        <select id="yearlyComparisonCountryFilter" class="form-select form-select-sm d-inline-block ms-2" style="width: auto;">
                            <option value="">Alle lande</option>
                            <option value="Danmark" selected>Danmark</option>
                            <option value="Norge">Norge</option>
                            <option value="Sverige">Sverige</option>
                        </select>
                        <button id="loadYearlyComparisonBtn" class="btn btn-primary btn-sm ms-2">
                            <i class="fas fa-sync"></i> Hent data
                        </button>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <div class="row mb-3" style="display: none;">
                            <div class="col-12">
                                <div class="card bg-success text-white yearly-totals-card">
                                    <div class="card-body text-center">
                                        <h6 class="card-title">År til dato sammenligning (1. jan - i dag)</h6>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="text-white">
                                                    <strong>2023:</strong> <span id="yearToDate2023" class="h6">-</span>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="text-white">
                                                    <strong>2024:</strong> <span id="yearToDate2024" class="h6">-</span>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="text-white">
                                                    <strong>2025:</strong> <span id="yearToDate2025" class="h6">-</span>
                                                </div>
                                            </div>
                                        </div>
                                        <small id="yearToDatePeriod">-</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="card bg-light yearly-totals-card">
                                    <div class="card-body text-center">
                                        <h6 class="card-title">2023 Total</h6>
                                        <div id="yearly2023Total" class="h5 text-info">-</div>
                                        <small class="text-muted" id="yearly2023Period">-</small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card bg-light yearly-totals-card">
                                    <div class="card-body text-center">
                                        <h6 class="card-title">2024 Total</h6>
                                        <div id="yearly2024Total" class="h5 text-success">-</div>
                                        <small class="text-muted" id="yearly2024Period">-</small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card bg-light yearly-totals-card">
                                    <div class="card-body text-center">
                                        <h6 class="card-title">2025 Total</h6>
                                        <div id="yearly2025Total" class="h5 text-warning">-</div>
                                        <small class="text-muted" id="yearly2025Period">-</small>
                                    </div>
                                </div>
                            </div>
                        </div>
