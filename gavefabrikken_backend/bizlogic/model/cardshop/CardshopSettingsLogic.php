...
class ShopExpireDate
{
    ...
    public function setAllInclusive($allInclusive = true)
    {
    ...
    public function toJsonArray()
    {
        ...
        return array(
            ...
            "all_inclusive" => $this->isAllInclusive()
        );
    }
...
class CardshopSettingsLogic
{
    ...
    public static function isCardshopAdmin($language_id = 0)
    {
        ...
        $seAdmins = array(124,162,153,304,291,301);
        $noAdmins = array(147,66,190,145,217,285,286,305,331);
    ...
    private function loadData($shopid)
    {
        ...
        foreach($expireDates as $expireDate) {
            ...
            if($weekObject != null) {
                $weekObject->setAllInclusive($this->settings->allinclusive == 1);
            }
