...
class ShopMetadata
{
    ...
    public static $metadata = array(
        ...
        2395 => array("valuealias" => "G11-", "name" => 13652, "address1" => 16642, "address2" => 16643, "zip" => 16644, "city" => 16645, "email" => 13653, "phone" => 16646, "gaveklub" => 13654, "country" => "Danmark", "lang_code" => "da", "lang_num" => 1),
        9321 => array("valuealias" => "G14-", "name" => 53906, "address1" => 53909, "address2" => 53910, "zip" => 53911, "city" => 53912, "email" => 53907, "phone" => 53913, "gaveklub" => 53908, "country" => "Danmark", "lang_code" => "da", "lang_num" => 1),
        ...
        7121 => array("valuealias" => "JGV-", "name" => 41004, "address1" => 0, "address2" => 0, "zip" => 0, "city" => 0, "email" => 41005, "phone" => 41013, "gaveklub" => 41006, "country" => "Danmark", "lang_code" => "da", "lang_num" => 1),
        ...
        8271 => array("valuealias" => "SOM-", "name" => 48621, "address1" => 48794, "address2" => 48795, "zip" => 48796, "city" => 48797, "email" => 48622, "phone" => 48798, "gaveklub" => 48623, "country" => "Sverige", "lang_code" => "se", "lang_num" => 5),
        ...
        8355 => array("valuealias" => "NL3", "name" => 49018, "address1" => 49096, "address2" => 49097, "zip" => 49098, "city" => 49099, "email" => 49019, "phone" => 49100, "gaveklub" => 49020, "country" => "Norge", "lang_code" => "no", "lang_num" => 4),
        8356 => array("valuealias" => "NL4", "name" => 49023, "address1" => 49101, "address2" => 49102, "zip" => 49103, "city" => 49104, "email" => 49024, "phone" => 49105, "gaveklub" => 49025, "country" => "Norge", "lang_code" => "no", "lang_num" => 4),
        8357 => array("valuealias" => "NL6", "name" => 49028, "address1" => 49106, "address2" => 49107, "zip" => 49108, "city" => 49109, "email" => 49029, "phone" => 49110, "gaveklub" => 49030, "country" => "Norge", "lang_code" => "no", "lang_num" => 4),
        8358 => array("valuealias" => "NL8", "name" => 49033, "address1" => 49111, "address2" => 49112, "zip" => 49113, "city" => 49114, "email" => 49034, "phone" => 49115, "gaveklub" => 49035, "country" => "Norge", "lang_code" => "no", "lang_num" => 4),
        8359 => array("valuealias" => "NL10", "name" => 49038, "address1" => 49116, "address2" => 49117, "zip" => 49118, "city" => 49119, "email" => 49039, "phone" => 49120, "gaveklub" => 49040, "country" => "Norge", "lang_code" => "no", "lang_num" => 4),
        8360 => array("valuealias" => "NL12", "name" => 49043, "address1" => 49121, "address2" => 49122, "zip" => 49123, "city" => 49124, "email" => 49044, "phone" => 49125, "gaveklub" => 49045, "country" => "Norge", "lang_code" => "no", "lang_num" => 4),
        8361 => array("valuealias" => "NL15", "name" => 49048, "address1" => 49126, "address2" => 49127, "zip" => 49128, "city" => 49129, "email" => 49049, "phone" => 49130, "gaveklub" => 49050, "country" => "Norge", "lang_code" => "no", "lang_num" => 4),
        8362 => array("valuealias" => "NL20", "name" => 49053, "address1" => 49131, "address2" => 49132, "zip" => 49133, "city" => 49134, "email" => 49054, "phone" => 49135, "gaveklub" => 49055, "country" => "Norge", "lang_code" => "no", "lang_num" => 4),
        8363 => array("valuealias" => "NL30", "name" => 49058, "address1" => 49136, "address2" => 49137, "zip" => 49138, "city" => 49139, "email" => 49059, "phone" => 49140, "gaveklub" => 49060, "country" => "Norge", "lang_code" => "no", "lang_num" => 4),
        8364 => array("valuealias" => "NL40", "name" => 49063, "address1" => 49141, "address2" => 49142, "zip" => 49143, "city" => 49144, "email" => 49064, "phone" => 49145, "gaveklub" => 49065, "country" => "Norge", "lang_code" => "no", "lang_num" => 4),
        8365 => array("valuealias" => "NL50", "name" => 49068, "address1" => 49146, "address2" => 49147, "zip" => 49148, "city" => 49149, "email" => 49069, "phone" => 49150, "gaveklub" => 49070, "country" => "Norge", "lang_code" => "no", "lang_num" => 4),
        8366 => array("valuealias" => "NL80", "name" => 49073, "address1" => 49151, "address2" => 49152, "zip" => 49153, "city" => 49154, "email" => 49074, "phone" => 49155, "gaveklub" => 49075, "country" => "Norge", "lang_code" => "no", "lang_num" => 4)
    );

    public static function getAttributeList($attr) {
        $list = array();
        foreach(self::$metadata as $shopid => $meta) {
            if(isset($meta[$attr]) && intval($meta[$attr]) > 0) {
                $list[] = intval($meta[$attr]);
            }
        }
        return $list;
    }

    public static function getNameAttrList() { return self::getAttributeList("name"); }
    public static function getAddress1AttrList() { return self::getAttributeList("address1"); }
    public static function getAddress2AttrList() { return self::getAttributeList("address2"); }
    public static function getZipAttrList() { return self::getAttributeList("zip"); }
    public static function getCityAttrList() { return self::getAttributeList("city"); }
    public static function getEmailAttrList() { return self::getAttributeList("email"); }
    public static function getPhoneAttrList() { return self::getAttributeList("phone"); }

    public static function getShopValueAlias($shopid) {
        if(!isset(self::$metadata[$shopid])) return "";
        return self::$metadata[$shopid]["valuealias"];
    }

    public static function getShopCountry($shopid) {
        if(!isset(self::$metadata[$shopid])) return "";
        return self::$metadata[$shopid]["country"];
    }

    public static function getShopLangCode($shopid) {
        if(!isset(self::$metadata[$shopid])) return 1;
        return self::$metadata[$shopid]["lang_num"];
    }

    public static function validShopID($shopid) {
        return isset(self::$metadata[$shopid]);
    }

    public static function getMetadata($shopid) {
        return self::validShopID($shopid) ? self::$metadata[$shopid] : null;
    }

    public static function getAllShopList() {
        return array_merge(self::getDAShops(),self::getSEShops(),self::getNOShops());
    }

    public static function getDAShops() {
        return array(54,55,56,575,4662,310,290,2548,53,2395,9321,52,4668,7122,7121,6989);
    }

    public static function getSEShops() {
        return array(1832,1981,2558,4793,5117,8271,9495);
    }

    public static function getNOShops()
    {
        return array(2549, 2550, 574, 59, 58, 57, 272,4740,8355, 8356, 8357, 8358, 8359, 8360, 8361, 8362, 8363, 8364, 8365, 8366);
    }
