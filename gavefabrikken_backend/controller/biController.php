...
";
    ...
    public function loadTotal(){
       ...
       $rangeSql = " and (created_datetime BETWEEN '2025-07-01 16:47:14' AND '2025-12-24 23:47:14' )";
...
/*------------------valgshop  --------------------------*/
    ...
    {
        $countryIdList["dk"] = "'52','53','54','55','56','290','310','575','2548','2395','9321','2960','2962','2963','2961','2999','4668','4662','7121','9321','9321'";
        $countryIdList["no"] = "'57','58','59','272','574','2549','2550','4740','8355', '8356', '8357', '8358', '8359', '8360', '8361', '8362', '8363', '8364', '8365', '8366'";
        $countryIdList["se"] = "'1832','1981','2558','4793','5117','8271','9495'";
