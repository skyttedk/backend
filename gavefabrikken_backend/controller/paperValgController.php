...
//$res = $papervalgHelper->findImg("70123");
    ...
    <div class="ele-border">
        ...
        <div class="ele-options">
            <div class="ele-option-title" ><div style="margin-right: 5px;"><b>'.$ele->attributes["alias"].'. </b></div><div> '.$papervalgHelper->getCaption($ele->attributes["id"]).'</div></div>
...
.head{
        height: 100px;
  width: 100%;
  background-image: url(https://system.gavefabrikken.dk/gavefabrikken_backend/views/media/icon/y569bvkjxf1568123658.jpg);
  background-repeat: no-repeat;
