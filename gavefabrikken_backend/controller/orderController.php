            ...
            if($shopuser->is_delivery == "1" ){
                ...
                if($order->shop_id == 1832 || $order->shop_id == 1981 || $order->shop_id == 2558 || $order->shop_id == 5117 || $order->shop_id == 4793 || $order->shop_id == 9495) {
                    ...
                    // OTHER DK
                        ...
                        $hjemmelevHtml = '<tr><td colspan="2"><hr><br><p>Dit gavevalg kan &aelig;ndres i 24 timer. Derefter overf&oslash;res dit valg til pakkeriet, og det vil herefter ikke v&aelig;re muligt at foretage &aelig;ndringer.</p><p>Din pakke bliver sendt med GLS og leveret til n&aelig;rmeste Pakkeshop.&nbsp;</p> <p>Vi afsender normalt din pakke indenfor 10 arbejdsdage dog tidligst den 2. december 2025.</p>                                   <p>Bem&aelig;rk at der kan opleves ekstra leveringstid op til 20 dage i h&oslash;js&aelig;sonen (december, januar og februar)</p>                                    <p>Har du bestilt et oplevelsesgavekort, ophold eller cruise vil det endelige gavekort blive sendt til dig. Denne kvittering kan derfor ikke benyttes som gavebevis.</p> <p>Husk, at du selv kan tilk&oslash;be flere designprodukter til gode priser p&aring;&nbsp;<a href="https://www.a58uy1lh5t1oilb67l0gaveklubben.dk/" target="_blank">GAVEKLUBBEN&trade;</a></p><br><br></td></tr>';
               try {
                   if($order->company_id == 61560){
                       $hjemmelevHtml = '<tr><td colspan="2"><hr><br><p>Dit gavevalg kan &aelig;ndres i 24 timer. Derefter overf&oslash;res dit valg til pakkeriet, og det vil herefter ikke v&aelig;re muligt at foretage &aelig;ndringer.</p><p>Din pakke bliver sendt med Postnord og leveret til n&aelig;rmeste Pakkeshop.&nbsp;</p> <p>Vi afsender normalt din pakke indenfor 10 arbejdsdage dog tidligst den 2. december 2025.</p>                                   <p>Bem&aelig;rk at der kan opleves ekstra leveringstid op til 20 dage i h&oslash;js&aelig;sonen (december, januar og februar)</p>                                    <p>Har du bestilt et oplevelsesgavekort, ophold eller cruise vil det endelige gavekort blive sendt til dig. Denne kvittering kan derfor ikke benyttes som gavebevis.</p> <p>Husk, at du selv kan tilk&oslash;be flere designprodukter til gode priser p&aring;&nbsp;<a href="https://www.a58uy1lh5t1oilb67l0gaveklubben.dk/" target="_blank">GAVEKLUBBEN&trade;</a></p><br><br></td></tr>';
                   }
                ...
                else if($order->shop_id == "1832" || $order->shop_id == "1981" || $order->shop_id == "2558" || $order->shop_id == "5117"  || $order->shop_id == "4793" || $order->shop_id == "9495") {
...
//        $maildata['mailserver_id'] = $shop->mailserver_id;
         $maildata['mailserver_id'] = 4;
          ...
          if($shop->id == 1832 || $shop->id == 1981 || $shop->id == 4793 || $shop->id == 5117 || $shop->id == 8271 || $shop->id == 9495) {
