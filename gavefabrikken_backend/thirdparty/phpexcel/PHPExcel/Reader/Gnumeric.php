		...
		if (isset($namespacesMeta['office'])) {
			...
			foreach($officeDocMetaXML as $officePropertyData) {
				...
				foreach($officePropertyDC as $propertyName => $propertyValue) {
					...
					switch ($propertyName) {
						case 'title' :
								$docProps->setTitle(trimgf($propertyValue));
								break;
						case 'subject' :
								$docProps->setSubject(trimgf($propertyValue));
								break;
						case 'creator' :
								$docProps->setCreator(trimgf($propertyValue));
								$docProps->setLastModifiedBy(trimgf($propertyValue));
								break;
						case 'date' :
								$creationDate = strtotime(trimgf($propertyValue));
								$docProps->setCreated($creationDate);
								$docProps->setModified($creationDate);
								break;
						case 'description' :
								$docProps->setDescription(trimgf($propertyValue));
								break;
					}
				}
				...
				foreach($officePropertyMeta as $propertyName => $propertyValue) {
					...
					switch ($propertyName) {
						case 'keyword' :
								$docProps->setKeywords(trimgf($propertyValue));
								break;
						...
						case 'user-defined' :
								...
								switch ($attrName) {
									case 'publisher' :
											$docProps->setCompany(trimgf($propertyValue));
											break;
									case 'category' :
											$docProps->setCategory(trimgf($propertyValue));
											break;
									case 'manager' :
											$docProps->setManager(trimgf($propertyValue));
											break;
								}
								break;
					}
