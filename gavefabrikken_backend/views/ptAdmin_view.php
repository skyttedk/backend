...
<div class="pt-admin">
  ...
  <div class="right">
    ...
    <fieldset>
      ...
      <fieldset>
          <legend>Priser Svrige</legend>
          <table>
              <tr>
                  <td>Specialaftale: </td><td>SPECIALAFTALE <input size="20"  id="pt_special_se" type="text"  /></td><td>Vis: <input type="checkbox" id="pt_special_show_se"></td>
              </tr>
              <tr>
                  <td>Budget: </td><td><input id="pt_pris_se" type="text" /></td><td>Vis: <input type="checkbox" id="pt_pris_show_se"></td>
              </tr>
              <tr>
                  <td>Vejl. udsalgspris: </td><td><input id="pt_budget_se" type="text" /></td><td>Vis: <input type="checkbox" id="pt_budget_show_se"></td>
