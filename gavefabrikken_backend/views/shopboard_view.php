...
<head>
  ...
  <link href="views/lib/jquery-ui/jquery-ui.css" rel="stylesheet" />
    <link href="views/lib/dataTables.css" rel="stylesheet" />
...
?>
<script src="views/lib/dataTables.js"></script>


<script>
var localization = <?php echo $language; ?>;
console.log(localization);
var tableHeight;
$( document ).ready(function() {

    controlHeight()
    shopboard.init(localization);
...
<body>
<input type="checkbox" id="localization" onclick="shopboard.setLocalization()"><label>Norsk</label>
