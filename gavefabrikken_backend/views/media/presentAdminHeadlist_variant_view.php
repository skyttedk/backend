...
<table width=700>
 <tr>
 <td> <input type='radio' class='presenttypesearch' name='presenttypesearch' id='searchPresents' value='searchPresents' ><label>Standard</label>   <input type='radio' checked id='searchVariants' class='presenttypesearch' name='presenttypesearch' value='searchVariants'><label style='margin-right:5px;'>Variant</label></td>
