...
if($_SESSION["syslogin".GFConfig::SALES_SEASON] == 46 || $_SESSION["syslogin".GFConfig::SALES_SEASON] == 49){
   $canEdit = "3";
...
<script>
 ...
 var _sysId   = "40" //'<?php echo $_SESSION["syslogin".GFConfig::SALES_SEASON]; ?>';
