...
<table width=100%>
 <tr>
 <td > <input type='radio' class='presenttypesearch' name='presenttypesearch' id='searchPresents' value='searchPresents' checked><label>Standard</label>   <input type='radio' id='searchVariants' class='presenttypesearch' name='presenttypesearch' value='searchVariants'><label style='margin-right:5px;'>Variant</label></td>
...
foreach($presents as $present)
{
	...
	<div class=\"flipper\">
        ...
        $html.= "<b><p class=\"present_no\"   id=\"present_no_".$present->id."\"  >".$present->attributes["nav_name"]."</p></b>
        ...
        $html.= "
                    ...
                    <td><img title=\"Opret ny copi\" onclick=\"copy.makeNewCopy('".$present->id."','".$present->attributes["nav_name"]."' )\"  src=\"views/media/icon/Copy-48.png\"  class=\"mouse noShop \" width=\"25\" height=\"25\"></td>
