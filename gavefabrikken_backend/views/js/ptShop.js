...
var ptShopClass = (function (presentId)
  {
    ...
    self.init = () => {
      ...
      if(_pt_show_frontpage_design == 1){
          $( ".pt_show_frontpage_design" ).prop( "checked", true );
      }
      if(_pt_bag == 1){
    ...
    self.setActions = () => {
      ...
      $('.pt_show_frontpage_design').on('change', self.updateFrontpageDesign);
    ...
    self.updatelanguage = () => {
      ...
      self.updateFrontpageDesign = () => {
          let isCheck = 0;
          if($(".pt_show_frontpage_design").prop('checked') == true){
              isCheck = 1;
          }
          $.ajax(
              {
                  ...
                  type: 'POST',
                  dataType: 'json',
                  data: {id: _shopId, pt_show_frontpage_design: isCheck }
              }).done(function(res) {
