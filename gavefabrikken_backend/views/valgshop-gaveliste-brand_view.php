...
//print_r($present);
	...
	<div class=\"flipper\">
        ...
        $html.= "<b><p class=\"present_no\">".$pim.$presentTitle."</p></b>
            <hr />
		...
		<div class=\"back\">
		   <div style=\"overflow-y:auto;  text-align: left; height: 240px; \">
                  <strong><p class=\"caption\" style=\"display:none;\">1".$present->descriptions[$localisation-1]->attributes["caption"]." </p></strong>
