...
if(!isset($_SESSION["syslogin".GFConfig::SALES_SEASON])){
...
<div class="main">
    ...
    <div id="content">  <center>
         ...
         <img style="margin-top:50px;" width=350 src="<?php echo GFConfig::BACKEND_URL; ?>views/images/dcs_img_1689650120_9f91298ede6d4704b482c6c942458688.webp" alt="" />

            <div style="padding: 50px; margin-top: 50px; padding-top: 0px; text-align: center;">
                <?php /* <h1 style="font-size: 34px; color: red;">SUPPORT: Ulrich er ikke tilgængelig hele onsdag d.2/11, kontakt derfor Søren på sc@interactive.dk</h1> */?>
                <h1 style="font-size: 34px; color: gray;">Gavevalg Systemet</h1>
